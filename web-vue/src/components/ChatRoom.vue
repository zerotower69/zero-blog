  ...
  <div>
    ...
    >
      ...
      <div class="footer">
        ...
        <!-- 表情 -->
        <i
          class="iconfont icon-biaoqian emoji"
...
export default {
  ...
  computed: {
    ...
    nickname() {
      console.log("这里的nickname", this.$store.state.nickname, this.ipAddr);
    ...
    avatar() {
      return this.$store.state.avatar != null
        ...
        : "http://zerotower.oss-cn-beijing.aliyuncs.com/mouse.jpg";
    },
    userId() {
