    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact">
          <a
            class="ml-5 mr-5 iconfont icon-qq"
            target="_blank"
            href="http://wpa.qq.com/msgrd?v=3&uin=1761552891&site=qq&menu=yes"
          />
          <a
            target="_blank"
            href="https://github.com/zerotower69"
            class="ml-5 mr-5 iconfont icon-github"
          />
          <a
            target="_blank"
            href="https://gitee.com/zerotower69"
            class="ml-5 mr-5 iconfont icon-gitee"
          />
        </div>
      </div>
      <!-- 向下滚动 -->
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold = new Date().getTime() - new Date("January 1,2021").getTime();
...
.home-banner {
  ...
  height: 100vh;
  background: #49b1f5
    url("http://zerotower.oss-cn-beijing.aliyuncs.com/eva/52ffdfd19c391b2cc6ee888f39845433.jpeg")
    50% / cover no-repeat;
  text-align: center;
  color: #fff !important;
