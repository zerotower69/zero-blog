<template>
  <div>
    ...
    <v-card class="blog-container">
      ...
      <blockquote>
        <div>名称：zerotower的技术小屋</div>
        <div>简介：我总会跨越前端的汪洋大海</div>
        <div>头像：http://zerotower.oss-cn-beijing.aliyuncs.com/aa.jpg</div>
      </blockquote>
      <div class="mt-5 mb-5">
        需要交换友链的可在下方留言💖
      </div>
...
.link-banner {
    background: #49b1f5 url(http://zerotower.oss-cn-beijing.aliyuncs.com/cover/wallhaven-nzq28o.jpg)  center center/cover no-repeat;
}
.link-title {
  color: #344c67;
  font-size: 21px;
